...
st.markdown(
    ...
    [data-testid="stFileUploaderDropzone"]{min-height:118px;padding:18px!important;border:1px dashed rgba(37,201,232,.35)!important;border-radius:14px!important;background:rgba(37,201,232,.045)!important;transition:border-color .16s ease,background .16s ease,transform .16s ease}
    ...
    [data-testid="stFileUploaderDropzone"] svg{width:30px!important;height:30px!important;color:var(--fh-cyan)!important;fill:var(--fh-cyan)!important}[data-testid="stFileUploaderDropzoneInstructions"] span{color:#fff!important;font-weight:750!important}[data-testid="stFileUploaderDropzoneInstructions"] small{color:var(--fh-muted)!important}
    [data-testid="stFileUploaderDropzone"] button{min-height:40px!important;border-color:rgba(37,201,232,.30)!important;background:rgba(37,201,232,.14)!important;color:var(--fh-cyan)!important;font-size:0!important}[data-testid="stFileUploaderDropzone"] button::after{content:"Seleccionar archivo";font-size:11px;font-weight:800}
